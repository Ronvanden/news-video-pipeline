...
- **Lokale Video-Linie (BA 20.x–32.x):** wiederholbare Pfade bis **`final_video.mp4`** (u. a. `scripts/run_url_to_final_mp4.py`, Founder Dashboard **Fresh Preview** vs. **Video generieren** / **BA 32.3**). Überblick: [PIPELINE_PLAN.md](PIPELINE_PLAN.md), Runbooks [docs/runbooks/real_video_build_wiring_map.md](docs/runbooks/real_video_build_wiring_map.md), [docs/runbooks/founder_production_flow_v1.md](docs/runbooks/founder_production_flow_v1.md).
...
- **Makro Phase 7 (Voiceover / TTS) — strukturierter Bauplan:** [docs/phases/phase7_voice_bauplan.md](docs/phases/phase7_voice_bauplan.md) (**Baustein 7.1–7.8**, Gates `compileall`/`pytest`; **nicht** BA 9.x / nicht Phase 10). **Phase-7-V1** (Preview + Commit auf `production_files`, OpenAI Speech) ist in [PIPELINE_PLAN.md](PIPELINE_PLAN.md) als **done** geführt; optional **Baustein 7.6** (zweiter TTS-Provider).
