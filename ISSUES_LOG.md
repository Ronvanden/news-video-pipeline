...
| 2026-04-29 | Watchlist / Automation | Scheduler-betrieb ohne abgesicherten Trigger | Produkt entscheidet: HTTP-Zyklus zuerst, GCP Cloud Scheduler später | Neue Endpoints **`POST /watchlist/jobs/run-pending`**, **`POST /watchlist/automation/run-cycle`** (Limits); **kein** Scheduler-/Deploy ohne separates Secret/Auth-Thema — siehe PIPELINE/README | dokumentiert | — |
