...
- **Runway Motion Live:** `POST /story-engine/runway-motion-live-execution`, bis zu **3** bestätigte Motion-Tasks im Dashboard, Output unter `output/storyboard_runs/<run_id>/<scene_id>/motion.mp4`.
