...
| **Bekannte Grenzen** | Schwere Videoverarbeitung oft nicht auf kleinen Cloud-Run-Instanzen; **Runway:** in **`run_ba265_url_to_final`** derzeit **höchstens ein** Motion-Slot-Clip (**BA 32.63**); Mehrfach-Clips / Last / Kosten noch offen (**BA 32.66** ff.). |
