...
class FounderDashboardRouteTests(unittest.TestCase):
    def test_dashboard_200_and_labels(self):
        ...
        self.assertIn("Founder Compact Summary", text)
        self.assertIn("founder-compact-bar", text)
        self.assertIn('id="fk-bar-potential"', text)
        self.assertNotIn("founder-summary-sticky", text)
