...
class FounderDashboardRouteTests(unittest.TestCase):
    def test_dashboard_200_and_labels(self):
        ...
        self.assertIn("ElevenLabs Voice erzeugen", text)
        ...
        self.assertIn("Storyboard Voice Mixdown", text)
        self.assertIn("Local Render Package bauen", text)
        self.assertIn("Storyboard Local Render Package", text)
        self.assertIn("Local Render starten", text)
        self.assertIn("Storyboard Local Render Execute", text)
        ...
        self.assertIn('id="btn-storyboard-local-render-execute"', text)
        ...
        self.assertIn('id="storyboard-local-render-execute-summary"', text)
        ...
        self.assertIn('id="out-storyboard-local-render-execute"', text)
        ...
        self.assertIn("/story-engine/runway-motion-live-execution", text)
        self.assertIn("/story-engine/storyboard-render-timeline", text)
        self.assertIn("/story-engine/storyboard-voice-mixdown", text)
        self.assertIn("/story-engine/storyboard-local-render-package", text)
        self.assertIn("/story-engine/storyboard-local-render-execute", text)
        ...
        self.assertIn("runStoryboardLocalRenderExecuteOnlyInternal", text)
        ...
        self.assertIn("renderRunwayMotionLiveSummary", text)
        self.assertIn("renderStoryboardRenderTimelineSummary", text)
        self.assertIn("renderStoryboardVoiceMixdownSummary", text)
        ...
        self.assertIn("max_live_image_tasks: 10", text)
        self.assertIn("max_live_voice_tasks: 10", text)
        self.assertIn("max_live_motion_tasks: 3", text)
        self.assertIn("max. 3 Motion Tasks", text)
        ...
        self.assertIn("Voice-Datei gespeichert", text)
        self.assertIn("Warnings / Voice failed", text)
        self.assertIn("Motion-Clip gespeichert", text)
        self.assertIn("Warnings / Motion failed", text)
        self.assertIn("confirm_provider_costs: confirmed", text)
        self.assertIn("motion_requested_but_no_clip_fallback_to_image", text)
        self.assertIn("Motion skipped", text)
        self.assertIn("Storyboard Local Render Package blockiert.", text)
        self.assertIn("Storyboard Voice Mixdown fehlgeschlagen.", text)
        self.assertIn("Storyboard Local Render Execute fehlgeschlagen.", text)
        self.assertIn("mixed_audio_path:", text)
        self.assertIn("Mixdown-Datei gespeichert", text)
        self.assertIn("timeline_manifest:", text)
        self.assertIn("asset_manifest:", text)
        self.assertIn("final_video:", text)
        self.assertIn("final_video_path:", text)
        self.assertIn("Final Video gespeichert", text)
        self.assertIn("render_output_manifest:", text)
        self.assertIn("storyboardRenderArtifactUrl", text)
        self.assertIn("appendStoryboardRenderArtifactLink", text)
        self.assertIn("/founder/dashboard/storyboard-render/file/", text)
    ...
    def test_storyboard_dashboard_markers_and_contract_guard(self):
        ...
        self.assertIn("lastElevenLabsVoiceLive", text)
        self.assertIn("lastStoryboardRenderTimeline", text)
        self.assertIn("Bilddatei gespeichert", text)
        self.assertIn("output_path:", text)
        self.assertIn("output_exists=false", text)
        self.assertEqual(
