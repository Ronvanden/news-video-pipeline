...
class FounderDashboardRouteTests(unittest.TestCase):
    def test_dashboard_200_and_labels(self):
        ...
        self.assertIn("Starte Videos, teste Bilder", text)
        ...
        self.assertIn("Was m&ouml;chtest du tun?", text)
        self.assertIn("data-dashboard-ux-cleanup-v1", text)
        self.assertIn("data-dashboard-ux-cleanup-v2", text)
        self.assertIn("Core bleibt oben", text)
        self.assertIn("Bild-Lab &ouml;ffnen", text)
        self.assertIn("Review &amp; Qualit&auml;t pr&uuml;fen", text)
        self.assertIn("Review &amp; Qualität", text)
        self.assertIn("Letzte Runs / Artefakte", text)
        self.assertIn("Advanced / Developer Tools", text)
        self.assertIn("Advanced Tools", text)
        self.assertIn('id="coll-advanced-actions"', text)
        self.assertIn("data-dashboard-advanced-tools", text)
        self.assertIn("Actions (Advanced)", text)
        self.assertIn("Technische Einzelaktionen", text)
        self.assertIn("Sicherer Prompt-Test", text)
        self.assertIn("Legacy / Debug - nur nutzen, wenn du weisst warum", text)
        self.assertIn("/visual-plan/presets", text)
        self.assertIn("Visual Prompt Controls", text)
        self.assertIn('id="visual-prompt-controls-panel"', text)
        self.assertIn('id="fd-visual-preset"', text)
        self.assertIn('data-visual-control="visual_preset"', text)
        self.assertIn('id="fd-prompt-detail-level"', text)
        self.assertIn('data-visual-control="prompt_detail_level"', text)
        self.assertIn('id="fd-provider-target"', text)
        self.assertIn('data-visual-control="provider_target"', text)
        self.assertIn('id="fd-text-safety-mode"', text)
        self.assertIn('data-visual-control="text_safety_mode"', text)
        self.assertIn('id="fd-visual-consistency-mode"', text)
        self.assertIn('data-visual-control="visual_consistency_mode"', text)
        self.assertIn("window.visualPromptControls", text)
        self.assertIn("loadVisualPromptControls", text)
        self.assertIn("resolveVisualPresetsEndpoint", text)
        self.assertIn('fetchJson(endpoint, { method: "GET" })', text)
        self.assertIn("Visual Controls derzeit nicht verfuegbar", text)
        self.assertIn("visual_prompt_controls", text)
        self.assertIn("visual-prompt-controls-preview-state", text)
        self.assertIn("window.visualPromptControlsDefaults", text)
        self.assertIn("window.visualPromptControlsPreviewState", text)
        self.assertIn("renderVisualPromptControlsPreviewState", text)
        self.assertIn("Preview-only visual controls state", text)
        self.assertIn('backend_payload: "not_sent"', text)
        self.assertIn("visual_prompt_controls_preview", text)
        self.assertIn("Visual Prompt Preview", text)
        self.assertIn('id="btn-visual-prompt-preview"', text)
        self.assertIn("resolveVisualPromptPreviewEndpoint", text)
        self.assertIn("/visual-plan/prompt-preview", text)
        self.assertIn("runVisualPromptPreviewOnlyInternal", text)
        self.assertIn("buildVisualPromptPreviewPayload", text)
        self.assertIn("visual-prompt-preview-result", text)
        self.assertIn("visual-prompt-preview-status", text)
        ...
        self.assertIn("Visual Prompt Anatomy", text)
        self.assertIn("prompt_quality_score", text)
        self.assertIn("prompt_risk_flags", text)
        self.assertIn("visual_prompt_anatomy", text)
        self.assertIn("visual_prompt_raw", text)
        self.assertIn("negative_prompt", text)
        self.assertIn("normalized_controls", text)
        self.assertIn("data-prompt-quality-cockpit", text)
        ...
        self.assertIn("liest den aktuellen Stand", text)
        ...
        self.assertIn("Ohne Live-Haken bleibt der Lauf im sicheren Fallback-Modus", text)
        ...
        self.assertIn("Mini-Lauf Preset", text)
        ...
        self.assertIn("Timeline Preview", text)
        self.assertIn("Timeline-Länge", text)
        self.assertIn("Audio-Länge", text)
        self.assertIn("Audio-Gap", text)
        self.assertIn("Gap-Ratio", text)
        self.assertIn("Metriken fehlen", text)
        self.assertIn("Tolerierte Warnungen", text)
        self.assertIn("Aktive Warnungen", text)
        self.assertIn("Ready: final video exists", text)
        self.assertIn("Ready with warnings", text)
        self.assertIn("Warning: final video exists", text)
        self.assertIn("Blocked: final video is missing", text)
